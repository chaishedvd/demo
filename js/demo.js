            ...
            $("#dialog-addconfirm").dialog({
                ...
                buttons: {
                    ...
                    "新增": function (e) {
                        ...
                        var ajaxobj = new AjaxObject(url, 'json');
                        var phone = $("#addenphone").val();
                        var email = $("#addenemail").val();
    ...
    AjaxObject.prototype.getall = function () {
      response = '[{"s_sn":"35","cnname":"邱小甘","enname":"Peter","sex":"0","phone":"0123456789","email":"test@gmail.com"},{"s_sn":"49","cnname":"蔡凡昕","enname":"Allen","sex":"0","phone":"1234567890","email":"test2@gmail.com"},{"s_sn":"50","cnname":"趙雪瑜","enname":"Sharon","sex":"0","phone":"2345678912","email":"test3@gmail.com"},{"s_sn":"51","cnname":"賴佳蓉","enname":"Yoki","sex":"1","phone":"3456789012","email":"test4@gmail.com"}]';
      refreshTable(JSON.parse(response));
    }
    AjaxObject.prototype.add = function () {
      response = '[{"s_sn":"35","cnname":"邱小甘","enname":"Peter","sex":"0","phone":"0123456789","email":"test@gmail.com"},{"s_sn":"49","cnname":"蔡凡昕","enname":"Allen","sex":"0","phone":"1234567890","email":"test2@gmail.com"},{"s_sn":"50","cnname":"趙雪瑜","enname":"Sharon","sex":"0","phone":"2345678912","email":"test3@gmail.com"},{"s_sn":"51","cnname":"賴佳蓉","enname":"Yoki","sex":"1","phone":"3456789012","email":"test4@gmail.com"},{"s_sn":"52","cnname":"新增帳號","enname":"NewAccount","sex":"1","phone":"0000000000","email":"new@gmail.com"}]';
      refreshTable(JSON.parse(response));
      $("#dialog-addconfirm").dialog("close");
    }
    AjaxObject.prototype.modify = function () {
      response = '[{"s_sn":"49","cnname":"蔡凡昕","enname":"Allen","sex":"0","phone":"1234567890","email":"test2@gmail.com"}]';
      refreshTable(JSON.parse(response));
    ...
    AjaxObject.prototype.search = function () {
      response = '[{"s_sn":"35","cnname":"邱小甘","enname":"Peter","sex":"0","phone":"0123456789","email":"test@gmail.com"}]';
      refreshTable(JSON.parse(response));
      $("#dialog-searchconfirm").dialog("close");
    }
    AjaxObject.prototype.delete = function () {
      response = '[{"s_sn":"35","cnname":"邱小甘","enname":"Peter","sex":"0","phone":"0123456789","email":"test@gmail.com"},{"s_sn":"49","cnname":"蔡凡昕","enname":"Allen","sex":"0","phone":"1234567890","email":"test2@gmail.com"}]';
      refreshTable(JSON.parse(response));
    }
